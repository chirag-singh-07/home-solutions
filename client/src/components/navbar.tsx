      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-4 h-16">
          <Link href="/" className="flex items-center gap-2 shrink-0" data-testid="link-home-logo">
            ...
            <span className="font-bold text-lg hidden sm:inline">HomesSolution</span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            <a href="tel:+919558473889" className="hidden sm:flex">
              <Button variant="outline" size="sm" data-testid="button-call">
                <Phone className="h-3.5 w-3.5 mr-1.5" />
                Call Us
              </Button>
            </a>
            <Link href="/book" data-testid="link-book-now">
      ...
      {mobileOpen && (
        <div className="md:hidden border-t bg-background">
          <div className="px-4 py-3 space-y-1">
            ...
            <a href="tel:+919558473889">
              <Button variant="outline" className="w-full justify-start mt-2">
                <Phone className="h-4 w-4 mr-2" />
                Call Us
              </Button>
            </a>
            <a href="https://wa.me/919558473889" target="_blank" rel="noopener noreferrer">
